...
import com.example.android.architecture.whj.listener.OnClickListener;
...
public abstract class ToolBarActivity extends UmengActivity {
    ...
    public class HeaderBuilder {
        public void setTitle(int resId) {
            ...
            String title = ContextUtils.getInstance().getResources().getString(resId);
        ...
        public void setRightTvSize(float textSize) {
            mRightTv.setTextSize(textSize);
        }
        ...
        public void setRightTvEnable(boolean able) {
            mRightTv.setEnabled(able);
        }
